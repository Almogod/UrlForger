...
STOPWORDS: frozenset = frozenset({
    ...
    "json", "xml", "rss", "pdf", "png", "jpg", "jpeg", "gif",
    "svg", "ico", "webp", "mp4", "mp3", "wav",
    "url", "link", "href", "src", "alt", "title",
    "page", "site", "website", "webpage", "web",
    "click", "here", "read", "more", "view", "download",
    "share", "tweet", "post", "comment", "reply",
    "login", "signup", "register", "subscribe", "submit",
    "search", "menu", "nav", "navigation", "sidebar",
    "header", "footer", "cookie", "cookies", "privacy",
    "terms", "disclaimer", "copyright",

    # ── SEO / HTML noise ──────────────────────────────────────────────
    "meta", "tag", "tags", "keyword", "keywords",
    "description", "content", "type", "name", "value",
    "class", "style", "div", "span", "section",
    "article", "aside", "main", "body", "head",
    ...
    "part", "parts", "piece", "pieces", "bit", "bits",
    "point", "points", "fact", "facts", "case", "cases",
    "time", "times", "day", "days", "year", "years",
    "example", "examples", "instance", "instances",
    "result", "results", "reason", "reasons", "number", "numbers",
    "hand", "hands", "end", "ends", "area", "areas",
    "state", "states", "place", "places", "form", "forms",
    "level", "levels", "side", "sides", "line", "lines",
    "work", "works", "word", "words",
    "need", "needs", "help", "helps",
    "question", "questions", "answer", "answers",
    "problem", "problems", "issue", "issues",
    "note", "notes", "list", "listed",
    "table", "figure", "image", "source", "sources",
    "according", "based", "related", "various",
    "today", "tomorrow", "yesterday",
    "information", "data", "detail", "details",
    "people", "person", "man", "woman", "men", "women",
    "child", "children", "group", "groups",
    "company", "companies", "business", "businesses",
    "service", "services", "product", "products",
    "market", "system", "program", "process",
    "order", "order", "world", "country", "countries",
    "home", "house", "school", "family", "student", "students",
    "hand", "eye", "eyes", "face", "head",
    "life", "story", "back", "city", "room",
    "team", "member", "members", "idea", "ideas",
    "plan", "plans", "period", "game", "games",
    "percent", "month", "months", "week", "weeks",
    "name", "names", "power", "money",
